...
let tasks = [
  ...
  { id: 25, task: "Do the new one", category: "Others", completed: false },
];
...
const renderTasks = () => {
  ...
  if (categoryTasks.length === 0) {
    tasksContainer.innerHTML = `
    <p class="no-task">No tasks are added here, Dude...</p>`
  } else {
